       ...
       <MediaQuery minWidth={360} maxWidth={1024}>
        <div className="detail-page__header">
            ...
            <div className="detail-page__header__wrapper">
             ...
             {userData.id.length !== 0 ? <button className="detail-page__header__posterAndbutton__add-button"
             onClick={addFavoriteMoviete} id={propDatas.id} ref={detailRef}><h4>收藏</h4></button>:null}
            </div>
